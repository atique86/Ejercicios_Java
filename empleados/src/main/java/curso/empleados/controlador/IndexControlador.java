package curso.empleados.controlador;

import curso.empleados.modelo.Empleado;
import curso.empleados.servicio.EmpleadoServicio;
...
public class IndexControlador {
    ...
    public String mostraEditar(@RequestParam int idEmpleado, ModelMap modelo){
    ...
    public String editar(@ModelAttribute("empleadoForma") Empleado empleado){
        ...
        empleadoServicio.guardarEmpleado(empleado);
        return "redirect:/"; // Redirigir el controlador a la ruta de inicio
    }
